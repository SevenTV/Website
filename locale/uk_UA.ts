export default {
	...
	activity: {
		...
		emote_renamed: "{ICO} Перейменував(-ла) {T} з {O} на {N}",
		...
		user_editor_added: "{T} Був доданий як редактор",
		user_editor_added_other: "Доданий {U1} як редактор {U2}",
		user_editor_removed: "{U} Був видалений як редактор",
		user_editor_removed_other: "Видалено {U1} як редактор {U2}",
