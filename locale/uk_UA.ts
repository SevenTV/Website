export default {
	...
	common: {
		...
		experimental_hint: "Ця функція є експериментальною та її стабільність не гарантована",
		comments: "Коментарі",
		search: "Пошук",
		update: "Оновити",
		report: "Поскаржитись",
		...
		object: {
			user: "Користувач",
			emote_set: "Набір смайлів",
			emote: "Смайл",
		},
	},
	// Text that appears on the home page
	home: {
		slogan: "Платформа смайлів для кожного",
		app_description: "Легко керуйте сотнями смайлів для ваших каналів Twitch або YouTube",
		why_app: "Чому @:common.appName{'?'}",
		download_browser: "Розширення браузера",
		download_mobile: "Мобільні додатки",
		download_misc: "Інші додатки",
		features: {
			emote_sets: {
				name: "Набори смайлів",
				detail: "Групуйте смайли в налаштовувальні набори, якими ви можете поділитися з іншими користувачами або швидко перегорнути на свій канал.",
			},
			many_emote_slots: {
				name: "Сотні слотів для смайлів",
				detail: "Усі отримують 600 налаштовувальних слотів смайлів, всі безплатно.",
			},
			channel_emote_names: {
				name: "Ви можете дати унікальну назву смайлам для вашого каналу",
				detail: "Не подобається ім'я смайла яке було встановлено автором? Нічого, ви можете змінити його персонально для свого каналу.",
			},
			real_time: {
				name: "Миттєві оновлення",
				detail: "Зміни смайлів у вашому каналі відбуваються миттєво для всіх глядачів. Оновлювати сторінку не треба.",
			},
			emote_versions: {
				name: "Версії смайлів",
				detail: "Перемикайтеся між тематичними варіантами смайлів або оновляйте їх на покращені версії.",
			},
			userbase: {
				name: "Велика спільнота",
				detail: "@:common.appName обслуговує {0}+ унікальних користувачів щодня та має бібліотеку з понад {1} публічних смайлів",
			},
			next_gen: {
				name: "Формати зображення нового покоління - WEBP та AVIF",
				detail: "Ми використовуємо новіші, більш оптимізовані формати зображень задля зменшення використання пропускної здатності.",
			},
			source_available: {
				name: "Доступний вихідний код",
				detail: "Наша кодова база доступна на GitHub з ліцензією на вихідний код. Кожен може переглядати та робити свій внесок.",
			},
		},
		socials: {
			discord: "Приєднуйтесь до @:common.appName в Discord",
			discord_online_count: "{0} активних користувачів",
		...
		legal: {
			...
			unaffiliated: "@:common.appName не має відношення до Twitch Interactive",
		},
	},
	// Nav Bar
	nav: {
		...
		admin: "Адмін",
		sign_in: "Увійти",
		user_search: "Пошук профілів",
		theme: "Перейти до {0} теми",
		theme_dark: "Темної",
		theme_light: "Світлої",
		theme_seasonal: "Сезонної",
		inbox: "Вхідні повідомлення",
		locale_selector: "Мова",
		locale_contribute: "Перекладіть @:common.appName{'!'}",
		wip_notice: {
			heading: "Ласкаво просимо до нового сайту @:common.appName",
			text1: "Це попередній перегляд наступного способу використання @:common.appName{'.'}",
			text2: "Дізнайтесь що нового і дайте нам відгук! Зверніть увагу, що сайт буде швидко змінюватись і може часто ламатися.",
		},
	},
	activity: {
		...
		emote_ownership_transferred: "Право власності {T} передано {U}",
		emote_restored: "Відновлено {T}",
		emote_updated: "Змінені властивості для {T}",
		emote_deleted: "{T} Був видалений",
		emote_tags_updated: "Встановити теги для {T}: {N}",
		...
		emote_flag_added: "Додано позначку {FLAG} до {T}",
		emote_flag_removed: "Користувач зняв позначку {FLAG} з {T}",
		emote_personal_use_validated: "{T} Було схвалено для особистого використання",
		emote_personal_use_rejected: "{T} Було відхилено для особистого використання",
		user_created: "Created {T}",
		user_deleted: "Deleted {T}",
		user_editor_added: "Користувач {U} доданий як редактор",
		user_editor_added_other: "Додано {U1} як редактора {U2}",
