export default {
	...
	activity: {
		...
		emote_renamed: "{ICO}-მ გადაარქვა {T}-ს {O}-დან {N}-ში",
		...
		user_editor_added: "{T} დამატებულია როგორც ედიტორი",
		user_editor_added_other: "{U1} დამატებულია როგორც {U2}-ს ედიტორი",
		user_editor_removed: "{U} წაშლილია ედიტორებისგან",
		user_editor_removed_other: "{U1} წაშლილია {U2}-ს ედიტორებისგან",
