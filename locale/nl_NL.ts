export default {
	...
	activity: {
		...
		emote_renamed: "{ICO} hernoemde {T} van {O} naar {N}",
		...
		user_editor_added: "{T} toegevoegd als een editor",
		user_editor_added_other: "{U1} toegevoegd als een editor van {U2}",
		user_editor_removed: "{U} verwijderd als een editor",
		user_editor_removed_other: "{U1} verwijderd als een editor van {U2}",
		...
		emote_set_emote_added: "De emote {AE} toegevoegd aan {T}",
		emote_set_emote_removed: "De emote {AE} verwijderd van {T}",
		emote_set_emote_renamed: "De emote {AE} van {O} naar {N} hernoemd in {T}",
