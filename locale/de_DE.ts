export default {
	...
	activity: {
		...
		emote_renamed: "{ICO} {T} von {O} zu {N} umbenannt",
		...
		user_editor_added: "{T} als Editor hinzugefügt",
		user_editor_added_other: "{U1} als Editor von {U2} hinzugefügt",
		user_editor_removed: "{U} als Editor entfernt",
		user_editor_removed_other: "{U1} wurde als Editor von {U2} entfernt",
	...
	emote_set: {
		...
		modal: {
			...
			rename_in_set: "Umbenennt zu {0}",
			context_rename: "Emote-Name anpassen",
			context_set_default: "Als Standard setzen",
