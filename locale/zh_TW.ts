export default {
	...
	home: {
		...
		features: {
			...
			channel_emote_names: {
				name: "自定貼圖名稱",
				detail: "不喜歡原作者的貼圖名稱嗎? 沒關係, 你可以於自己的的頻道更改",
			},
			real_time: {
				name: "實時更新",
	...
	activity: {
		emote_created: "已製作{T}",
		emote_renamed: "{ICO} 把 {T} 由 {O} 重新命名至 {N}",
		...
		user_created: "已新加{T}",
		user_deleted: "已移除{T}",
		user_editor_added: "已新增編輯者{T}",
		user_editor_added_other: "已新增{U1} 為{U2} 的編輯者",
		user_editor_removed: "已移除編輯者{U}",
		user_editor_removed_other: "已移除{U1} 為{U2} 的編輯者",
		user_banned: "已封鎖{T}",
