export default {
	...
	activity: {
		...
		emote_renamed: "{ICO} أعيدت تسمية {T} من {O} إلى {N}",
		...
		user_editor_added: "تم إضافة {T} كمعدل",
		user_editor_added_other: "تم إضافة {U1} كمعدل لـ {U2}",
		user_editor_removed: "تمت إزالة {U} كمعدل",
		user_editor_removed_other: "تمت إزالة {U1} كمعدل لـ {U2}",
