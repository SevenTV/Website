export default {
	...
	emote_set: {
		...
		explain: {
			...
			hint: "Los conjuntos de emotes son una colección de emoticonos que pueden ser vinculados a tus canales o compartidos con otros usuarios.",
		},
	...
	user: {
		...
		editors: "Editores",
		roles: "Roles",
		no_channel_emotes: "{0} no tiene ningún emote en su canal {1}",
