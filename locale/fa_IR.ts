export default {
	...
	activity: {
		...
		emote_renamed: "{ICO} نام {T} را از {O} به {N} تغییر داد",
		...
		user_editor_added: "{T} را به عنوان ادیتور اضافه کرد",
		user_editor_added_other: "{U1} به عنوان ادیتور {U2} اضافه شد",
		user_editor_removed: "{U} به عنوان ادیتور حذف شد",
		user_editor_removed_other: "{U1} به عنوان ادیتور {U2} حذف شد",
		user_banned: "{T} بن شد",
