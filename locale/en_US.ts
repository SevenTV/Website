export default {
	...
	activity: {
		...
		user_created: "Created {U}",
		user_deleted: "Deleted {U}",
		...
		user_editor_removed_other: "Removed {U} as an editor of {U2}",
		user_banned: "Banned {U}",
		user_unbanned: "Unbanned {U}",
		user_updated: "Changed properties for {U}",
		user_sign_in: "{U} has signed in",
		user_sign_out: "{U} has logged out",
		user_forbidden: "{U} was denied access to {0}",

		emote_set_created: "Created {ES}",
		emote_set_emote_added: "Added the emote {E} to {ES}",
		emote_set_emote_removed: "Removed the emote {E} from {ES}",
		emote_set_emote_renamed: "Renamed the emote {E} from {0} to {1} in {ES}",
		emote_set_updated: "Changed properties for {ES}",
	},
