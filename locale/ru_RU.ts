export default {
	...
	activity: {
		...
		emote_renamed: "{ICO} Переименован {T} из {O} на {N}",
		...
		emote_updated: "Изменены свойства для {T}",
		...
		user_editor_added: "Пользователь {T} добавлен в качестве редактора",
		user_editor_added_other: "Пользователь {U1} добавлен в качестве редактора {U2}",
		user_editor_removed: "Пользователь {U} отстранён в качестве редактора",
		user_editor_removed_other: "Пользователь {U1} отстранён в качестве редактора {U2}",
		user_banned: "Пользователь {T} забанен",
		user_unbanned: "Пользователь {T} разбанен",
		user_updated: "Изменены свойства для {T}",
		...
		emote_set_updated: "Изменены свойства для {T}",
	},
