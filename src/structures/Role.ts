...
export const Permissions = {
	...
	RolePermissionRunJobs: (1n << 57n) as Role.Permission, // 144115188075855872 - (Admin) Allows managing thing
	RolePermissionManageEntitlements: (1n << 58n) as Role.Permission, // 288230376151711744 - (Admin) Allows managing entitlements
};
