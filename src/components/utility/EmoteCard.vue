...
const bgRotate = `rotate(${[0, 90, 180, 270][Math.floor(Math.random() * 3)]}deg)`;
const bgPath = `path("${
	[
		...
		"M1.73,3.73,6,0H25.38L31.5,4.5l-4,5,5,7V9.12l5-3.62-3-4L36.92,0H65.17L77.5,4.5l8-2,5,4L101.25,0H146l9.5,1.5,4.5,6-3.5,6L160,23.58a.28.28,0,0,1,0,.09v2.89L157.75,30l-2.19-2.69L153,29.24l-3.46-4.42-.76-5.26L147,23.48l2.39,7.29-4.06.71-2.44-8.13-9.06-.7,6.59,3.25,3.5,8.83,5.91-.42-1.91,3.84L152,43.48l-.08-5.92,3.75-4.91L160,35.19V66.38L156.5,86.5,160,99.75V124l-6.5,3.5,6.5,5v10.62l-3.38,12.5-4.87-3-3,7.38h-44l.75-4.75-4.12-3.87,3.62-4-9,2.12,4.38,5.5-9.13,5H41.75l-12.63-6.12L18.75,160l-4.37-3.25L9.62,160H0V123.12l6.75,4.26L0,112.12V78.38l11.5-3.26L0,72V41.62L4.88,25.25,0,14.5,2.38,7.88Z",
