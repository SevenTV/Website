<template>
	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 640 480">
		...
		<g transform="translate(0 26.7) scale(1.06667)">
			...
			/>
			<g id="pt_PT_e">
				<g id="pt_PT_d" fill="#ff0" stroke="#000" stroke-width=".5">
					...
					/>
					<path id="pt_PT_a" d="M191 141.6v3.4h-4v-3.4h4z" />
					<use xlink:href="#pt_PT_a" width="100%" height="100%" x="10.6" />
					<path
						id="pt_PT_b"
						d="M186.3 139h1.2v1h.9v-1h1.2v1h.9v-1h1.2v2c0 .4-.2.6-.5.6h-4.3a.6.6 0 0 1-.6-.6v-2z"
					/>
					<use xlink:href="#pt_PT_b" width="100%" height="100%" x="10.6" />
					<path fill="#000" stroke="none" d="M193.9 140.6c0-.6.9-.6.9 0v1.6h-.9v-1.6" />
					<path id="pt_PT_c" fill="#000" stroke="none" d="M188.6 142.8c0-.6.8-.6.8 0v1.2h-.8v-1.2" />
					<use xlink:href="#pt_PT_c" width="100%" height="100%" x="10.6" />
				</g>
				<use xlink:href="#pt_PT_d" width="100%" height="100%" y="46.3" />
				<use xlink:href="#pt_PT_d" width="100%" height="100%" transform="rotate(-45.2 312.8 180)" />
			</g>
			<use xlink:href="#pt_PT_d" width="100%" height="100%" x="45.7" />
			<use xlink:href="#pt_PT_e" width="100%" height="100%" transform="matrix(-1 0 0 1 479.8 0)" />
			<g id="pt_PT_f" fill="#fff">
				<path
					fill="#039"
			...
			<use xlink:href="#pt_PT_f" width="100%" height="100%" y="-26" />
			<use xlink:href="#pt_PT_f" width="100%" height="100%" x="-20.8" />
			<use xlink:href="#pt_PT_f" width="100%" height="100%" x="20.8" />
			<use xlink:href="#pt_PT_f" width="100%" height="100%" y="25.8" />
		</g>
	</svg>
</template>
