<template>
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 109.6 80.9" width="1em">
		<defs>
			<linearGradient
				id="Test"
				x1="0%"
		...
		<g>
			<path d="M84.1,22.2l5-8.7,2.7-4.6L86.8.2V0H60.1l5,8.7,5,8.7,2.8,4.8H84.1" fill="url(#Test)" />
			<path
				fill="url(#Test)"
