<template>
	...
	<p>
		The words of which the initial letter is capitalised have meanings defined under the following conditions. The
	...
	<ul>
		...
		<li>
			<p class="no-indent">
				...
				electronic device, named SEVENTV SARL
			</p>
		</li>
		<li>
			<p class="no-indent">
	...
	<ul>
		...
		<li>
			<p class="no-indent"><strong>To manage your requests:</strong> To attend and manage your requests to us.</p>
		</li>
		<li>
			<p class="no-indent">
				<strong>For business transfers:</strong> we may use your information to evaluate or conduct a merger,
				divestiture, restructuring, reorganisation, dissolution, or other sale or transfer of some or all of our
