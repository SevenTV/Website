...
import { faSun as fasSun, faMoon as fasMoon, faCircle as fasCircle, faBars as fasBars } from "@fortawesome/free-solid-svg-icons";
import { faChrome as fabChrome, faTwitter as fabTwitter, faGithub as fabGithub } from "@fortawesome/free-brands-svg-icons";

library.add(fasSun, fasMoon, fabChrome, fabTwitter, fabGithub, fasCircle, fasBars);
